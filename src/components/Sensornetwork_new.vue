<template>
  <div class="sensornetwork">
    ...
    <div class="main">
      ...
      <div class="first">
        <div class="tables">
          <!--选项--> <a id="shishi" @click="RealTimeFatch()" class="bai">实时</a>
        ...
        <div class="query24" style="width: 100%;height: 50px;padding-top: 49px;padding-left: 10px">
          <!---->
          <div class="shijian">
            <!--时间选择--> <span style="font-size: 15px;font-weight: bold;padding-right: 10px">监测点分类</span>

            <el-select v-model="KeyDvalue" placeholder="请选择">
              <el-option v-for="item in FENoptions" :key="item.value" :label="item.label"
      ...
      <div class="table_container">
        <el-table :data="tableData" border stripe highlight-current-row @current-change="RowCurrentChange"
                  style="width:100%">
          <el-table-column property="ranking" width="60" label="排名"></el-table-column>
          <el-table-column property="Grid"  width="100" label="网格名称"></el-table-column>
          <el-table-column property="stationname" label="名称"></el-table-column>
          <el-table-column property="aqi" width="70" :label="type"></el-table-column>
        </el-table>
