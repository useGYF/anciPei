...
const apiconfig = [
  {
    devn: 'http://58.132.207.211:8072',//测试（尚丽娜,吴印照.net)
    devc: 'http://58.132.207.211:8070',//测试（张培涵java接口）
    devy: 'http://58.132.207.211:8073',//测试（大气原清单模块java)
  ...
  },
  {
    ...
    devn: 'http://120.52.157.162:4035',//正式（尚丽娜,吴印照.net)
...
const apilangfangTDK = {
  ...
  GetWeatherWinterPre: apiconfig[1].devm + '/api/Weather/GetWeatherWinterPre',//冬防战报模块六天气排名
  ...
  GetCameraList: apiconfig[icode].devc + '/guangyang/company/getCameraList',//视频列表页面数据
  ...
  removeInspectorCasePage: apiconfig[icode].devc + '/guangyang/cases/removeInspectorCasePage',//大数据督查案件删除
  /*
  * 右侧列表
  * */
    GetSootPointList: apiconfig[icode].devn + '/api/Soot/getSootPointList?',//餐饮油烟右侧
    GetSootPointListData: apiconfig[icode].devc + '/guangyang/company/getSootPointList?companyName=',//餐饮油烟监控列表
    SiteDustListData: apiconfig[icode].devc + '/guangyang/siteDust/list?keyword=',//工地扬尘列表接口
    VocsListData: apiconfig[icode].devc + '/guangyang/vocs/list?keyword=',//VOC列表接口
    /*
    * 查询公司违规次数列表
    * */
  GetIGyGridinfo: apiconfig[icode].devc + '/guangyang/cases/getGyGridinfo',//查询所有网格信息
  GetCompanysList: apiconfig[icode].devc + '/guangyang/company/getCompanyCasenum',//查询公司违规次数列表；
    /*
    * 后台--巡查员管理
    * */
  ...
  SuperviseCaseGridRatio: apiconfig[icode].devc + '/guangyang/cases/selectSuperviseCaseGridRatio',//查询督察案件网格占比
    /*
    * 网格巡查员-案件处理
    * */
  ...
  * */
  ...
  GetVideoDeviceInfo: apiconfig[icode].devc + '/guangyang/company/getCompanys',//(广阳)获取所有监控点列表数据
...
export const removeInspectorCasePageResource = API_ROOT.concat(apilangfangTDK.removeInspectorCasePage);
