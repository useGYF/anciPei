  ...
  <div class="CaseEntry">
    ...
    <div id="CaseIn">
      ...
      <div class="CaseIn_add">
        ...
        <div class="CaseIn_add_cell">
          <span>企业名称</span>
          <el-select v-model="CaseInParam.companyId" filterable placeholder="请选择">
            <el-option
    ...
    <div class="case_submit">
      ...
      <el-button type="primary" class='btns' @click='cancel'>取消</el-button>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      addCase() {
        ...
        let id = addParam.id;
        api.addCaseList(id,companyId, name, sendPeople, feedbackPeople, caseType, sendTime, feedbackTime, videoFootage, caseDescript, feedbackDescript, feedbackFootage, source).then(res => {
          //console.log(res)
          t.$message({
            message: '案件录入成功',
            type: 'success'
      ...
      editRow(row){
        console.log(row);
        this.CaseInParam.type = row.caseType;
        this.CaseInParam.returnName = row.feedbackPeople;
        this.CaseInParam.sendName = row.sendPeople;
        this.CaseInParam.returnTime = row.feedbackTime;
        this.CaseInParam.sendTime = row.sendTime;
        this.CaseInParam.companyId = row.companyId;
        this.CaseInParam.region = this.changeCseResource(row.sourceString);
        this.CaseInParam.describe = row.caseDescript;
        this.CaseInParam.returnRes = row.feedbackDescript;
        this.CaseInParam.fileUrl = row.videoFootage;
        this.CaseInParam.fileUrlAfter = row.afterCaseImg;
        this.CaseInParam.id = row.id;
      },
      changeCseResource(val){
          if(val == '指挥中心'){
            return '1'
          }else if(val =='大气办'){
            return '2'      
