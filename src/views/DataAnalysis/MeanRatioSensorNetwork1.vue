    ...
    <div class="Meanratiosensornetwork">
        ...
        <div class="warp6">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                <el-tab-pane label="国控点均值比" name="first">
                    <!---->
                    <!---->
                    <div class="kass" v-if='false'>
                        <div class="wbiaoti">
                            <a>查询条件</a>
                        </div>
                    </div>
                    <!--查询条件-->
                    <div class="chaxuntiaojian" v-if='false'>
                        <div class="float001">
                    ...
                    <!--自定义选择框-->
                    <div class="custom" v-show="region =='自定义'? true:false" v-if='false'>
                        <!--国控点-->
                        <div class="gs_box">
                ...
                <el-tab-pane label="小时浓度" name="second" v-if='false'>
                    <!---->
                    <!---->
                    <div class="kass">
                        <div class="wbiaoti">
                ...
                <el-tab-pane label="日均值比" name="third" v-if='false'>
                    <!---->
                    <!---->
                    <div class="kass">
                        <div class="wbiaoti">
                ...
                <el-tab-pane label="日浓度" name="fourth" v-if='false'>
                    <!---->
                    <!---->
                    <div class="kass">
                        <div class="wbiaoti">
    ...
    export default {
        ...
        data() {
            return {
                ...
                region: '自定义',
                //初始值
                epelements:['北华航天工业学院','第十中学','三河交通局'],
                //初始选项值1
                checkedCities1: [],
                //初始选项值2
                checkedCities2: ['北华航天工业学院','第十中学','三河交通局'],
                //国控点选项
                cities1: [],
                //省控点选项
                cities2: ['北华航天工业学院','第十中学','三河交通局'],
                //现在时间
                nowtime:'',
        ...
        created() {
            //默认初始值
            this.getTimeNow();
            this.GetChangeofData();
            this.getHourConcentrationData('ZDY','pm25',this.nowtime,'');
            this.getDayConcentrationData('ZDY','pm25',this.startDay,this.endDay,'')
        },
        beforeMount() {
            //beforeMount 挂载前状态===
        },
