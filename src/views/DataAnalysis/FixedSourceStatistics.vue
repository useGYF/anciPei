                ...
                <el-tab-pane label="监测数据" name="first">
                    ...
                    <div class="chaxuntiaojian">
                        <div class="float001">
                            <span>企业名称</span>
                            <!--选择器-->
                            <el-select v-model="QyValue" filterable  placeholder="请选择企业" @change="changeoptions">
                                <el-option
                            ...
                            <span>排气口</span>
                            <!--选择器-->
                            <el-select v-model="pqValue" filterable  placeholder="请选择排气口" @change="changepaiqi">
                                <el-option
                ...
                <el-tab-pane label="超标统计" name="second">
                    ...
                    <div class="chaxuntiaojian">
                        ...
                        <div class="float001">
                            <span>企业名称</span>
                            <!--选择器-->
                            <el-select v-model="QyValue" filterable  placeholder="请选择" @change="changeoptions">
                                <el-option
                                        v-for="item in QyOptions"
                                        :key="item.value"
                                        :label="item.label"
    ...
    export default {
        ...
        methods: {
            ...
            getListData(){
              ...
              let code = this.codevalue || '131000000100';
              let outputcode = this.exhaustData || 2;
